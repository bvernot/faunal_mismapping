...
query_file = "/mnt/expressions/robin_warner/3_faunal-mismapping/bin/big-simulations/0_faunalizer/faunalization_query.tsv"
output_file = "/mnt/expressions/benjamin_vernot/faunal_mismapping/data/big-simulations/multifaunalized.eigenstratgeno"
...
# print(f"Faunalizing {reduced_eigenstrat_df.shape[0]:_} of {eigenstrat_df.shape[0]:_} SNPs ({reduced_eigenstrat_df.shape[0]/eigenstrat_df.shape[0]:.2e})")
# for ind, ((_, target_row), (_, source_row)) in enumerate(zip(target_df.iterrows(), source_df.iterrows())):
#     print(eigenstrat_df["full_str"].str.slice(target_row[""]))
