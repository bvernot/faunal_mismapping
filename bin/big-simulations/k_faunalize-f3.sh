...
python \
    ...
    $not_lenient_geno > $F3Dir/$analysis_name/"poseidon-with-faunal-inds-triallelic-removed-1240k-subset-FAUNALIZED_not_lenient_STATS.txt"
...
python \
    ...
    $broad_inds_queryfile \
    $lenient_geno \
    -l > $F3Dir/$analysis_name/"poseidon-with-faunal-inds-triallelic-removed-1240k-subset-FAUNALIZED_lenient_STATS.txt"
...
dataset_name="poseidon-with-faunal-inds-triallelic-removed-1240k-subset-60-per-cent"

### Create a new .ind file replacing Population IDs for chosen popuations (which is needed for pairwise analysis)
cat $EIGENSTRAT_subsetDir/$dataset_name.ind  | awk '{
    if ($3=="Sardinian" || $3=="Han" || $3=="Papuan" || $3=="French" || $3=="Orcadian" || $3=="Italian_North")
    print $1,$2,$1
    else 
    print $1,$2,$3
    }' > $EIGENSTRAT_subsetDir/$dataset_name-ADJUSTED-POP-IDS.ind

# ### Make a new directory for F3 Statistics outputs
mkdir -p $F3Dir

# # ### Define common parameters
ind_file=$EIGENSTRAT_subsetDir/$dataset_name-ADJUSTED-POP-IDS.ind
snp_file=$EIGENSTRAT_subsetDir/$dataset_name.snp
original_geno=$EIGENSTRAT_subsetDir/$dataset_name.eigenstratgeno

#############################################################################################
##################  Analysis #3 - run on broad populations with 60% subset ##################
#############################################################################################
analysis_name="3_SNP-subset-60-per-cent-broad_analysis"
mkdir -p $F3Dir/$analysis_name
broad_analysis_all_inds=$(echo HGDP00666 HGDP00667 HGDP00668 HGDP00669 HGDP00670 HGDP00671 HGDP00672 HGDP00774 HGDP00775 HGDP00776 HGDP00777 HGDP00779 HGDP00780 HGDP00781 HGDP00540 HGDP00541 HGDP00543 HGDP00545 HGDP00546 HGDP00547 HGDP00548)
...
# ### Run the faunalizer to create the new .geno files
# ## Not lenient version
not_lenient_geno=$F3Dir/$analysis_name/$dataset_name"-FAUNALIZED_not_lenient.eigenstratgeno"
# python \
#     /mnt/expressions/robin_warner/3_faunal-mismapping/bin/big-simulations/0_faunalizer/multi-faunalizer_v4.py \
#     $original_geno \
#     $ind_file \
#     $broad_inds_queryfile \
#     $not_lenient_geno > $F3Dir/$analysis_name/$dataset_name"-FAUNALIZED_not_lenient_STATS.txt"

# # ## Lenient version
lenient_geno=$F3Dir/$analysis_name/$dataset_name"-FAUNALIZED_lenient.eigenstratgeno"
# python \
#     /mnt/expressions/robin_warner/3_faunal-mismapping/bin/big-simulations/0_faunalizer/multi-faunalizer_v4.py \
#     $original_geno \
#     $ind_file \
#     $broad_inds_queryfile \
#     $lenient_geno \
#     -l > $F3Dir/$analysis_name/$dataset_name"-FAUNALIZED_lenient_STATS.txt"
...
# # ##############################################################################
# # ####################  Analysis #4 - Modern Europeans Only with 60% subset ####################
# # ##############################################################################
analysis_name="4_SNP-subset-60-per-cent-modern-europe"
mkdir -p $F3Dir/$analysis_name
modern_europeans_all_inds=$(echo HGDP00666 HGDP00667 HGDP00668 HGDP00669 HGDP00670 HGDP00671 HGDP00672 HGDP00511 HGDP00512 HGDP00513 HGDP00514 HGDP00515 HGDP00516 HGDP00517 HGDP00794 HGDP00796 HGDP00797 HGDP00798 HGDP00799 HGDP00800 HGDP00802 HGDP01147 HGDP01151 HGDP01152 HGDP01153 HGDP01155 HGDP01156 HGDP01157)
