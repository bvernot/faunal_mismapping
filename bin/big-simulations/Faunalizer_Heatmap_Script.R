...
heatmap.2(mat_data,
          ...
          colRow = colour_ordered,
          colCol = colour_ordered,
          labRow = paste(as.vector(not_lenient_data_with_colour$NotLenientLabel),sep=""),
          labCol = paste(as.vector(not_lenient_data_with_colour$NotLenientLabel),sep=""),
          #Colv=if(symm)"Rowv" else TRUE,
          #dendrogram="col",
          #notecol="green",
          margins =c(7,7))
...
png(paste(work,analysis_name,"/lenient/",analysis_name,"-lenient-HEATMAP.png", sep=""), height=15, width=15, res=300, units="cm")
...
heatmap.2(mat_data,
          ...
          colRow = colour_ordered,
          colCol = colour_ordered,
          labRow = paste(as.vector(lenient_data_with_colour$LenientLabel),sep=""),
          labCol = paste(as.vector(lenient_data_with_colour$LenientLabel),sep=""),
          #Colv=if(symm)"Rowv" else TRUE,
          #dendrogram="col",
          #notecol="green",
          margins =c(7,7))
...
############################## 3_SNP-subset-60-per-cent-broad_analysis ############################## 
analysis_name=paste("3_SNP-subset-60-per-cent-broad_analysis")
...
############################## 4_SNP-subset-60-per-cent-modern-europe ############################## 
